    ...
    try {
      ...
      if (response.success) {
        ...
        const transformedLeaves = (response.leaves || []).map((leave) => ({
          ...
          reason: leave.reason,
          status: leave.gedApprovalStatus === "pending" ? "Pending" : 
                  leave.gedApprovalStatus === "approved" ? "Approved" : "Rejected",
        }));
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <h1 className="text-2xl font-bold text-gray-800 mb-6">
        Leave Management (Final Approval)
      </h1>
      ...
      {activeTab === "requests" ? (
        <div className="bg-white rounded-xl shadow-md p-6 overflow-x-auto">
          <h2 className="text-lg font-semibold text-gray-700 mb-4">
            Pending Leave Requests (HOD & HR Approved)
          </h2>
