...
function LeaveRequestsPreview() {
  ...
  const getStatusDisplay = (leave) => {
    if (leave.hrApprovalStatus === "rejected") return "Rejected";
    if (leave.hrApprovalStatus === "approved") return "Approved";
    return "Pending";
  };

  const getStatusColor = (leave) => {
    if (leave.hrApprovalStatus === "rejected") return "text-red-600";
    if (leave.hrApprovalStatus === "approved") return "text-green-600";
