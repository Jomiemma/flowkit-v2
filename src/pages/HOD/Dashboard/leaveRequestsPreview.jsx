...
function LeaveRequestsPreview() {
  ...
  const getStatusDisplay = (leave) => {
    if (leave.hodApprovalStatus === "rejected") return "Rejected";
    if (leave.hodApprovalStatus === "approved") return "Approved";
    return "Pending";
  };

  const getStatusColor = (leave) => {
    if (leave.hodApprovalStatus === "rejected") return "text-red-600";
    if (leave.hodApprovalStatus === "approved") return "text-green-600";
