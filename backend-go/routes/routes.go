...
func SetupRoutes(router *gin.Engine) {
	...
	protected.Use(middleware.AuthMiddleware())
	{
		...
		hod.Use(middleware.AuthorizeRoles("hod", "superhod", "admin"))
		{
			...
			hod.GET("/dashboard/stats", handlers.GetHODDashboardStats) // HOD dashboard stats
		}
		...
		hr.Use(middleware.AuthorizeRoles("hr", "admin"))
		{
			...
			hr.GET("/dashboard/stats", handlers.GetHRDashboardStats) // HR dashboard stats
		}
		...
		ged.Use(middleware.AuthorizeRoles("ged", "admin"))
		{
			...
			ged.GET("/dashboard/stats", handlers.GetGEDDashboardStats) // GED dashboard stats
		}
